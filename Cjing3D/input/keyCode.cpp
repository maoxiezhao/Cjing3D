...
namespace Cjing3D
{
	...
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Unknown)
	...
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Pause)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(PrintScreen)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(NumLock)
	// mouse
	...
	// gamepad
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_CountStart)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Up)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Down)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Left)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Right)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_A)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_B)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_X)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Y)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Start)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_Back)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_LeftShoulder)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_RightShoulder)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_LeftStick)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_RightStick)
	ENUM_TRAITS_REGISTER_ENUM_DEFINE(Gamepad_CountEnd)
