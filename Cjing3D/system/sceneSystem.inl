...
template<> inline ECS::ComponentManager<NameComponent>& Scene::GetComponentManager() { return mNames; }
...
template<> inline ECS::ComponentManager<AABBComponent>& Scene::GetComponentManager() { return mObjectAABBs; }
