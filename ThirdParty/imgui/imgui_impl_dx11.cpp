...
// Cjing3D data
Cjing3D::Texture2D g_pFontTextureView;
...
static void ImGui_ImplDX11_CreateFontsTexture()
{
	...
	// convert to Cjing3D texture 
	{
		...
		Cjing3D::Renderer::GetDevice().CreateTexture2D(&desc, &subresourceData, g_pFontTextureView);
	}
...
void    ImGui_ImplDX11_InvalidateDeviceObjects()
{
	...
	// Cjing3D objects
	if (g_pFontTextureView.IsValid()) { g_pFontTextureView.Clear(); }
}
